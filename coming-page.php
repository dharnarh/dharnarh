...
<head>
  ...
  <meta property="og:image" content="../wp-content/themes/umar/assets/images/og:preview.png" />
  ...
  <meta name="twitter:image" content="../wp-content/themes/umar/assets/images/og:preview.png" />

  <!-- favicon generator -->
  <link rel="icon" type="image/x-icon" href="../wp-content/themes/umar/assets/favicon/favicon.ico" />
  <link rel="apple-touch-icon" sizes="180x180" href="../wp-content/themes/umar/assets/favicon/apple-touch-icon.png" />
  <link rel="icon" type="image/png" sizes="32x32" href="../wp-content/themes/umar/assets/favicon/favicon-32x32.png" />
  <link rel="icon" type="image/png" sizes="16x16" href="../wp-content/themes/umar/assets/favicon/favicon-16x16.png" />
  <link rel="manifest" href="../wp-content/themes/umar/assets/favicon/site.webmanifest" />

  <!-- css fonts and bootstrap -->
  <link rel="preconnect" href="https://fonts.gstatic.com" />
  <link href="https://fonts.googleapis.com/css2?family=Jost:wght@400;700&display=swap" rel="stylesheet" />
  <link rel="stylesheet" href="../wp-content/themes/umar/assets/css/bootstrap.css" />
...
<body class="bg-light">
  <div class="container-fluid vh-100 p-0 m-0">
    <div class="container h-100 d-flex flex-column justify-content-between">
      ...
      <ul class="nav flex-row py-3 small justify-content-center">
        <li class="nav-item">
