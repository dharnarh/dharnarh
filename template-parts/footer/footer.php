<div class="container-fluid d-flex flex-column justify-content-center mt-4 py-4 border-top p-0">
  <p class="text-dark text-center fw-bold mb-0">I am Social</p>
  <ul class="nav flex-row justify-content-center py-3 small">
    <li class="nav-item">
